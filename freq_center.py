...
#左辺
#天井
roof_l1 = f*10**6/10**(-0.091*np.sqrt(epsilon_r1)*losstangent*R1/5*f)
roof_l2 = f*10**6/10**(-0.091*np.sqrt(epsilon_r1)*losstangent*R2/5*f)
roof_l3 = f*10**6/10**(-0.091*np.sqrt(epsilon_r1)*losstangent*R3/5*f)
roof_l4 = f*10**6/10**(-0.091*np.sqrt(epsilon_r1)*losstangent*R4/5*f)
roof_l5 = f*10**6/10**(-0.091*np.sqrt(epsilon_r1)*losstangent*R5/5*f)

#床
floor_l1 = f*10**6/10**(-0.091*np.sqrt(epsilon_r1)*losstangent*R3/5*f)
floor_l2 = f*10**6/10**(-0.091*np.sqrt(epsilon_r1)*losstangent*R4/5*f)
floor_l3 = f*10**6/10**(-0.091*np.sqrt(epsilon_r1)*losstangent*R5/5*f)
floor_l4 = f*10**6/10**(-0.091*np.sqrt(epsilon_r1)*losstangent*R6/5*f)
floor_l5 = f*10**6/10**(-0.091*np.sqrt(epsilon_r1)*losstangent*R7/5*f)


#右辺
#天井
roof_r1 = P_t/P_min * (G_t**2 * c * RCS)/((4*np.pi)**3 * R1**4) * through**3 * reflection + f*0
roof_r2 = P_t/P_min * (G_t**2 * c * RCS)/((4*np.pi)**3 * R2**4) * through**3 * reflection + f*0
roof_r3 = P_t/P_min * (G_t**2 * c * RCS)/((4*np.pi)**3 * R3**4) * through**3 * reflection + f*0
roof_r4 = P_t/P_min * (G_t**2 * c * RCS)/((4*np.pi)**3 * R4**4) * through**3 * reflection + f*0
roof_r5 = P_t/P_min * (G_t**2 * c * RCS)/((4*np.pi)**3 * R5**4) * through**3 * reflection + f*0
#床
floor_r1 = P_t/P_min * (G_t**2 * c * RCS)/((4*np.pi)**3 * R3**4) * through**2 * reflection + f*0
floor_r2 = P_t/P_min * (G_t**2 * c * RCS)/((4*np.pi)**3 * R4**4) * through**2 * reflection + f*0
floor_r3 = P_t/P_min * (G_t**2 * c * RCS)/((4*np.pi)**3 * R5**4) * through**2 * reflection + f*0
floor_r4 = P_t/P_min * (G_t**2 * c * RCS)/((4*np.pi)**3 * R6**4) * through**2 * reflection + f*0
floor_r5 = P_t/P_min * (G_t**2 * c * RCS)/((4*np.pi)**3 * R7**4) * through**2 * reflection + f*0
